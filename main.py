...
def analyze(req: AnalyzeRequest):
    log.info(
        "received POST /analyze: clip=%s audio=%s secondsPerFrame=%s max_frames=%s",
        req.path,
        req.audio,
        req.secondsPerFrame,
        req.max_frames,
...
def analyze_upload(
    ...
    log.info(
        "received POST /analyze/upload: content_type=%s size=%s audio=%s secondsPerFrame=%s max_frames=%s",
        file.content_type,
        file.size,
        audio,
        secondsPerFrame,
